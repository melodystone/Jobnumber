 ...
 */
final class Version20210806145627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE staff (id INT AUTO_INCREMENT NOT NULL, department_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, sex VARCHAR(255) DEFAULT NULL, tel VARCHAR(255) DEFAULT NULL, jobnumber INT NOT NULL, INDEX IDX_426EF392AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
